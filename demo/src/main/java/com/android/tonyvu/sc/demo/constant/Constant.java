...
public final class Constant {
    ...
    public static final Product PRODUCT4 = new Product(4, "Xiaomighhg Mi3", BigDecimal.valueOf(319.99), "Xiaomi's Mi 3 is a showcase of how Chinese phonemakers can create quality hardware without breaking the bank. If you don't need 4G LTE, and you can get hold of it, this is one of the best smartphones you can buy in its price range.");
